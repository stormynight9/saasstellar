        ...
        <section className='mx-auto mb-8 mt-28 px-5 dark:bg-[radial-gradient(ellipse_40%_50%_at_50%_-20%,hsla(20.5,90.2%,48.2%,0.3),#ffffff00)]'>
            ...
            <div className='mx-auto flex max-w-7xl flex-col gap-6 text-center'>
                ...
                <div className='mt-10 flex flex-col items-center gap-6 lg:flex-row lg:items-start'>
                    ...
                    <div className='gradient-border relative max-w-sm flex-grow basis-0 rounded-md bg-gradient-to-b from-primary/10 via-transparent to-transparent p-8 before:bg-gradient-to-b before:from-primary before:to-transparent'>
                        <div className='flex flex-col gap-3 text-left'>
                            <p>Pro</p>
                            <div className='flex items-start gap-2'>
                                <span className='text-2xl text-muted-foreground'>
                    ...
                    <div className='gradient-border relative max-w-sm flex-grow basis-0 rounded-md bg-gradient-to-br from-primary/10 via-transparent to-transparent p-8 before:bg-gradient-to-br before:from-primary/30 before:to-transparent'>
                        <div className='flex flex-col gap-3 text-left'>
                            <p>Premium</p>
                            <div className='flex items-start gap-2'>
                                <span className='text-2xl text-muted-foreground'>
